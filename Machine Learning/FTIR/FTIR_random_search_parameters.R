...
Fl.1<-as.factor(Data_floral.origin$Floral.origin)                           # change the name of the factor column
ftir_spectra<-Data_floral.origin[,-1867]                                   # only spectra
ftir_Data<-cbind(ftir_spectra,Fl.1)                                         # all data (spectra+category)
...
x11()
plot(accuracy_poly, type="l", ylab = "Cummulative accuracy", xlab = "Iterations",ylim = c(0,1),
