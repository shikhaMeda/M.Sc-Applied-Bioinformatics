...
Fl.1<-as.factor(Data_floral.origin$Floral.origin)                            #floral category as factor
ftir_spectra<-Data_floral.origin[,-1867]                                     # remove category
...
plot(accuracy_nb_floral, type="l", ylab = "Cummulative accuracy", xlab = "Iterations",ylim = c(0,1),
     main = paste("Accuracy of","Honey","naiveBayes", "over 100 iterations"))
